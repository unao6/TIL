package io.elice.elcademy.member.controller;

import io.elice.elcademy.member.entity.Member;
import io.elice.elcademy.member.entity.MemberPostDto;
import io.elice.elcademy.member.mapper.MemberMapper;
import io.elice.elcademy.member.service.MemberService;
...
public class MemberController {
    ...
    @GetMapping
    public ResponseEntity<List<Member>> getmembers(@RequestParam(name = "page", defaultValue = "1") int page, @RequestParam(name = "size", defaultValue = "3") int size) {
